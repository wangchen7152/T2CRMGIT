# Generated by Django 3.2 on 2022-11-04 22:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cusManager', models.CharField(db_column='cus_manager', max_length=128)),
                ('level', models.CharField(max_length=128, verbose_name='客户级别')),
                ('myd', models.CharField(max_length=128, verbose_name='客户满意度')),
                ('xyd', models.CharField(max_length=128, verbose_name='信用度')),
                ('address', models.CharField(max_length=128, verbose_name='地址')),
                ('postCode', models.CharField(db_column='post_code', max_length=128)),
                ('phone', models.CharField(max_length=128)),
                ('fax', models.CharField(max_length=128)),
                ('web_url', models.CharField(db_column='web_url', max_length=128)),
                ('company_num', models.CharField(max_length=128, verbose_name='营业注册号')),
                ('leader_of_company', models.CharField(max_length=128, verbose_name='法人')),
                ('registered_capital', models.CharField(max_length=128, verbose_name='注册资本')),
                ('annual_turnover', models.CharField(max_length=128, verbose_name='年营业额')),
                ('bank', models.CharField(max_length=128, verbose_name='开户银行')),
                ('bank_number', models.CharField(max_length=128, verbose_name='开户账号')),
                ('land_tax', models.CharField(max_length=128, verbose_name='地税')),
                ('the_irs', models.CharField(max_length=128, verbose_name='国税')),
                ...
                ('deleted', models.IntegerField(choices=[(0, '未删除'), (1, '已删除')], default=0, null=True, verbose_name='是否删除')),
                ('city', models.ForeignKey(db_column='city_id', on_delete=django.db.models.deletion.DO_NOTHING, to='customer.citycourse', verbose_name='所属城市')),
            ],
            options={
                'verbose_name': '客户信息表',
                'verbose_name_plural': '客户信息表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cusNo', models.CharField(db_column='cus_no', max_length=24)),
